...
func NewHelloAPI(spec *loads.Document) *HelloAPI {
	return &HelloAPI{
		...
		GetIPHandler: GetIPHandlerFunc(func(params GetIPParams) middleware.Responder {
			return middleware.NotImplemented("operation GetIP has not yet been implemented")
		}),
	}
}
...
type HelloAPI struct {
	...
	// GetIPHandler sets the operation handler for the get IP operation
	GetIPHandler GetIPHandler
...
func (o *HelloAPI) Validate() error {
	...
	if o.GetIPHandler == nil {
		unregistered = append(unregistered, "GetIPHandler")
	}
...
func (o *HelloAPI) initHandlerCache() {
	...
	o.handlers["GET"]["/ip"] = NewGetIP(o.context, o.GetIPHandler)
}
